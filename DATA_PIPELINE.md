...
| **Data Types** | Gán toàn bộ bằng `VARCHAR(MAX)` | Ngăn chặn triệt để lỗi *Data Truncation* khi import. |
...
*(Hình ảnh thực tế 5 bảng dữ liệu đã được tạo thành công trong SQL Server)*
